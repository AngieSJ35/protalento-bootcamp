...
public class CineMain {
	...
	public static void main(String[] args) {
		...
		//recorrer las personas que entran al cine y quiero saber si son director
		for(Persona aux : personas) {
			...
			if(aux instanceof Director) {
				...
				System.out.println("Director: tiene "+ d.getEmpACargo() + " empleados a cargo y va a una silla especial!!");
			}
		}
